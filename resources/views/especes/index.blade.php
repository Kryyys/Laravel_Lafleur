        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h1 class="text-center text-3xl font-bold underline pb-10">{{__("List of all species")}}</h1>
                        ...
                        <div class="mx-auto my-2 p-6 bg-white dark:bg-gray-800">
                            <table class="w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-left text-s font-medium text-gray-500 tracking-wider">{{$espece->id}}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-left text-s font-medium text-gray-500 tracking-wider">{{$espece->espece}}</td>
                                        <td class="flex pt-4">
                                            <x-update :espece="$espece"></x-update>
                                            <x-delete :action="route('especes.destroy', $espece->id)">
                                    ...
                                    @else
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap" colspan="2">{{ __('No saved species') }}</td>
                                    </tr>
                                    @endif
                                </tbody>
                            </table>
